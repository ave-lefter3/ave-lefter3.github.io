...
/*!******************************************************************************!*\
  !*** ./node_modules/@solflare-wallet/metamask-sdk/lib/esm/detectProvider.js ***!
  \******************************************************************************/
/*! exports provided: isSnapSupported, detectProvider */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSnapSupported", function() { return isSnapSupported; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "detectProvider", function() { return detectProvider; });
...
/*!*********************************************************************!*\
  !*** ./node_modules/@solflare-wallet/metamask-sdk/lib/esm/index.js ***!
  \*********************************************************************/
/*! exports provided: StandardSolflareMetaMaskWalletAccount, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var eventemitter3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! eventemitter3 */ "./node_modules/@solflare-wallet/metamask-sdk/node_modules/eventemitter3/index.js");
...
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! uuid */ "./node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/utils.js");
/* harmony import */ var _detectProvider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./detectProvider */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/detectProvider.js");
/* harmony import */ var _standard_account__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./standard/account */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/account.js");
/* harmony import */ var _standard_solana__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./standard/solana */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/solana.js");
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./types */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/types.js");
/* empty/unused harmony star reexport *//* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "StandardSolflareMetaMaskWalletAccount", function() { return _standard_account__WEBPACK_IMPORTED_MODULE_6__["StandardSolflareMetaMaskWalletAccount"]; });
...
class SolflareMetaMask extends eventemitter3__WEBPACK_IMPORTED_MODULE_1___default.a {
    constructor(config) {
        super();
    ...
    `;
        ...
        this._sendIframeMessage = (data) => {
            ...
            return new Promise((resolve, reject) => {
                var _a, _b;
                const messageId = Object(uuid__WEBPACK_IMPORTED_MODULE_3__["v4"])();
        ...
        this._standardConnected = () => {
            ...
            if (!this._account || this._account.address !== address) {
                this._account = new _standard_account__WEBPACK_IMPORTED_MODULE_6__["StandardSolflareMetaMaskWalletAccount"]({
                    address,
    ...
    signTransaction(transaction) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const serializedTransaction = Object(_utils__WEBPACK_IMPORTED_MODULE_4__["serializeTransaction"])(transaction);
                const response = yield this._sendIframeMessage({
                    method: 'signTransactionV2',
                    params: {
                        transaction: bs58__WEBPACK_IMPORTED_MODULE_2___default.a.encode(serializedTransaction)
                    }
                });
                const { transaction: signedTransaction } = response;
                return Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isLegacyTransactionInstance"])(transaction) ? _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__["Transaction"].from(bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signedTransaction)) : _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__["VersionedTransaction"].deserialize(bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signedTransaction));
            }
            catch (e) {
    ...
    signAllTransactions(transactions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const serializedTransactions = transactions.map((transaction) => Object(_utils__WEBPACK_IMPORTED_MODULE_4__["serializeTransaction"])(transaction));
                const { transactions: signedTransactions } = yield this._sendIframeMessage({
                    method: 'signAllTransactionsV2',
                    params: {
                        transactions: serializedTransactions.map((transaction) => bs58__WEBPACK_IMPORTED_MODULE_2___default.a.encode(transaction))
                    }
                });
                return signedTransactions.map((signedTransaction, index) => {
                    return Object(_utils__WEBPACK_IMPORTED_MODULE_4__["isLegacyTransactionInstance"])(transactions[index]) ? _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__["Transaction"].from(bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signedTransaction)) : _solana_web3_js__WEBPACK_IMPORTED_MODULE_0__["VersionedTransaction"].deserialize(bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signedTransaction));
                });
            }
            catch (e) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const { signature } = yield this._sendIframeMessage({
                    method: 'signMessage',
                    params: {
                        data: bs58__WEBPACK_IMPORTED_MODULE_2___default.a.encode(data),
                        display
                    }
                });
                return Uint8Array.from(bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signature));
            }
            catch (e) {
    ...
    static isSupported() {
        return __awaiter(this, void 0, void 0, function* () {
            const provider = yield Object(_detectProvider__WEBPACK_IMPORTED_MODULE_5__["detectProvider"])();
            return !!provider;
        });
    }
    standardSignAndSendTransaction(...inputs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs.length === 1) {
                ...
                if (!Object(_standard_solana__WEBPACK_IMPORTED_MODULE_7__["isSolanaChain"])(chain))
                ...
                outputs.push({ signature: bs58__WEBPACK_IMPORTED_MODULE_2___default.a.decode(signature) });
            }
    ...
    standardSignTransaction(...inputs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (inputs.length === 1) {
                ...
                if (account !== this._account)
                    throw new Error('invalid account');
                if (chain && !Object(_standard_solana__WEBPACK_IMPORTED_MODULE_7__["isSolanaChain"])(chain))
                    throw new Error('invalid chain');
                ...
                for (const input of inputs) {
                    if (input.account !== this._account)
                        throw new Error('invalid account');
                    if (input.chain) {
                        if (!Object(_standard_solana__WEBPACK_IMPORTED_MODULE_7__["isSolanaChain"])(input.chain))
                            throw new Error('invalid chain');
                        if (chain) {
...
/*!********************************************************************************!*\
  !*** ./node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/account.js ***!
  \********************************************************************************/
/*! exports provided: StandardSolflareMetaMaskWalletAccount */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StandardSolflareMetaMaskWalletAccount", function() { return StandardSolflareMetaMaskWalletAccount; });
/* harmony import */ var _solana_wallet_standard_features__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @solana/wallet-standard-features */ "./node_modules/@solana/wallet-standard-features/lib/esm/index.js");
/* harmony import */ var _solana_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./solana.js */ "./node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/solana.js");
...
const chains = _solana_js__WEBPACK_IMPORTED_MODULE_1__["SOLANA_CHAINS"];
const features = [_solana_wallet_standard_features__WEBPACK_IMPORTED_MODULE_0__["SolanaSignAndSendTransaction"], _solana_wallet_standard_features__WEBPACK_IMPORTED_MODULE_0__["SolanaSignTransaction"], _solana_wallet_standard_features__WEBPACK_IMPORTED_MODULE_0__["SolanaSignMessage"]];
...
/*!*******************************************************************************!*\
  !*** ./node_modules/@solflare-wallet/metamask-sdk/lib/esm/standard/solana.js ***!
  \*******************************************************************************/
/*! exports provided: SOLANA_MAINNET_CHAIN, SOLANA_DEVNET_CHAIN, SOLANA_TESTNET_CHAIN, SOLANA_LOCALNET_CHAIN, SOLANA_CHAINS, isSolanaChain */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOLANA_MAINNET_CHAIN", function() { return SOLANA_MAINNET_CHAIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOLANA_DEVNET_CHAIN", function() { return SOLANA_DEVNET_CHAIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOLANA_TESTNET_CHAIN", function() { return SOLANA_TESTNET_CHAIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOLANA_LOCALNET_CHAIN", function() { return SOLANA_LOCALNET_CHAIN; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SOLANA_CHAINS", function() { return SOLANA_CHAINS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isSolanaChain", function() { return isSolanaChain; });
...
/*!*********************************************************************!*\
  !*** ./node_modules/@solflare-wallet/metamask-sdk/lib/esm/utils.js ***!
  \*********************************************************************/
/*! exports provided: isLegacyTransactionInstance, serializeTransaction, serializeTransactionMessage, addSignature */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isLegacyTransactionInstance", function() { return isLegacyTransactionInstance; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "serializeTransaction", function() { return serializeTransaction; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "serializeTransactionMessage", function() { return serializeTransactionMessage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addSignature", function() { return addSignature; });
...
/* harmony import */ var _stringify_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stringify.js */ "./node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/stringify.js");
/* harmony import */ var _parse_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./parse.js */ "./node_modules/@solflare-wallet/metamask-sdk/node_modules/uuid/dist/esm-browser/parse.js");
